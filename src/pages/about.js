        ...
        <section id="cta" className="section" style={{ flexDirection: 'column', paddingBottom: 50 }}>
            <div className="sectionHeader">
                <div className="titleLineWrapper">
                    ...
                    <p className="bodyText">In February 2020 President Cyril Ramaphosa launched a youth employment intervention, a strategic national vision and plan poised to address youth unemployment. <br /><br />
                        ...
                        The app is friendly to use and is available for download from Google Play or the Apple app store.</p>
                </div>
            </div>
